...
RSpec.describe ContentCmds::Admin::Create do
  ...
  describe '#call' do
    describe 'success' do
      ...
      it 'creates a new content' do
        expect {
          ContentCmds::Admin::Create.call(context, content_params.merge(company_id: current_admin_user.company_id), params)
        }.to change { Content.count }.by(1)
      end

      it 'correct attributes' do
        cmd = ContentCmds::Admin::Create.call(context, content_params.merge(company_id: current_admin_user.company_id), params)
    ...
    describe "validation" do
      ...
      context "when title has trailing whitespace" do
        ...
        it "should increase content number" do
          content_params = params[:content]
